...
private:
    ...
    /// </summary>
	void					ProcessColor();
    void                    ProcessSkeleton(HWND *hwnd);
    ...
    void                    DrawBone(const NUI_SKELETON_DATA & skel, NUI_SKELETON_POSITION_INDEX bone0, NUI_SKELETON_POSITION_INDEX bone1,HWND *hwnd,float *angle);
    ...
    void                    DrawSkeleton(const NUI_SKELETON_DATA & skel, int windowWidth, int windowHeight, HWND *hwnd,const NUI_IMAGE_FRAME *imgFrame);
    ...
    D2D1_POINT_2F           SkeletonToScreen(Vector4 skeletonPoint, int width, int height, const NUI_IMAGE_FRAME *imgFrame);
