...
public:
    ...
    void SetImageType(NUI_IMAGE_TYPE type)
    {
		...
		void SetStreamViewerAccel(NuiAccelerometerViewer* pViewer);
		void ProcessStream(NuiAccelerometerViewer* m_pAccelerometerViewer);
...
private:
    ...
    void DrawBone(const NUI_SKELETON_DATA& skeletonData, const D2D1_RECT_F& imageRect, NUI_SKELETON_POSITION_INDEX joint0, NUI_SKELETON_POSITION_INDEX joint1,float *angle);
	void BoneAngle(const NUI_SKELETON_DATA & skel, NUI_SKELETON_POSITION_INDEX joint0, NUI_SKELETON_POSITION_INDEX joint1, int bone,const D2D1_RECT_F& imageRect);
    /// <summary>
