...
void NuiSkeletonStream::AssignSkeletonFrameToStreamViewers(const NUI_SKELETON_FRAME* pFrame)
{
	...
	void NuiSkeletonStream::ProcessStream(NuiAccelerometerViewer* m_pAccelerometerViewer)
	{
		// Get the reading
		Vector4 reading;
	...
	//	HRESULT hr = m_pNuiSensor->NuiAccelerometerGetCurrentReading(&reading);
		...
		//	m_pAccelerometerViewer->SetAccelerometerReadings(&angle1,);
		}
	}

	void NuiSkeletonStream::SetStreamViewerAccel(NuiAccelerometerViewer* pViewer)
	{
